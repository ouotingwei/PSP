...
void merge_and_save(){
    ...
    // if (pcl::io::loadPCDFile<pcl::PointXYZRGBA>("/home/wei/PSP/files/point_cloud.pcd", *cloud1) == -1)
    // {
    ...
    pcl::PointCloud<pcl::PointXYZRGBA>::Ptr cloud2_spl_tmp(new pcl::PointCloud<pcl::PointXYZRGBA>());
    ...
    pcl::transformPointCloud(*D_sample_2, *cloud2_spl_tmp, rotation);
    ...
    // shift cloud2_spl
    Eigen::Affine3f translation_cloud2 = Eigen::Affine3f::Identity();
    translation_cloud2.translation() << SHIFT_X, SHIFT_Y, SHIFT_Z;
    pcl::PointCloud<pcl::PointXYZRGBA>::Ptr shifted_cloud2(new pcl::PointCloud<pcl::PointXYZRGBA>());
    pcl::transformPointCloud(*cloud2_spl_tmp, *cloud2_spl, translation_cloud2);
